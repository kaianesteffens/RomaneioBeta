"""Provider BORNELLI (Azul Erechim) - Sistema SSW de Transportes (mesmo portal da Eucatur)."""
...
class BornelliProvider(ProviderBase):
    """Provider BORNELLI (Azul Erechim) via portal SSW (sistema.ssw.inf.br)."""
    ...
    async def coteir(self, origem: str, destino: str, peso: float, valor: float,
        ...
        """Realiza cotação de frete via portal SSW BORNELLI."""
