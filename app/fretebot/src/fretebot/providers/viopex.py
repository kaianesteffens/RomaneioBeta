"""Provider VIOPEX - Sistema SSW de Transportes (mesmo portal da Eucatur)."""
...
class ViopexProvider(ProviderBase):
    """Provider VIOPEX via portal SSW (sistema.ssw.inf.br)."""
    ...
    async def coteir(self, origem: str, destino: str, peso: float, valor: float,
        ...
        """Realiza cotação de frete via portal SSW VIOPEX."""
