"""Provider MENGUE EXPRESS - Sistema SSW de Transportes (mesmo portal da Eucatur)."""
...
class MengueProvider(ProviderBase):
    """Provider MENGUE EXPRESS via portal SSW (sistema.ssw.inf.br)."""
    ...
    async def coteir(self, origem: str, destino: str, peso: float, valor: float,
        ...
        """Realiza cotação de frete via portal SSW MENGUE."""
