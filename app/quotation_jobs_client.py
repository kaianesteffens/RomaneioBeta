...
def _get_quotation_jobs_api_url() -> str:
    ...
    for env_name in ("FRETIO_QUOTATION_JOBS_API_URL", "FRETEBOT_QUOTATION_JOBS_API_URL"):
        ...
        if url:
            return require_https_url(url, DEFAULT_QUOTATION_JOBS_API_URL).rstrip("/")
    cfg = _get_config_value("quotation_jobs_api_url") or DEFAULT_QUOTATION_JOBS_API_URL
    return require_https_url(cfg, DEFAULT_QUOTATION_JOBS_API_URL).rstrip("/")
...
def _get_quotation_normalization_api_url() -> str:
    ...
    cfg = _get_config_value("quotation_normalization_api_url") or DEFAULT_QUOTATION_NORMALIZATION_API_URL
