...
- rank 5 (CWE-312): config_salvar_credenciais roteia senhas para o Credential
  Manager e nunca as grava em texto claro no CONFIG.toml.
- rank 19 (CWE-532): nome da empresa é mascarado nos logs de aviso.
"""
import logging
import sys
import types
